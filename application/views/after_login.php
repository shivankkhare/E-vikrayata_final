                    ...
                    <nav class="h-100 navbar navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse" id="dorneNav">
                            ...
                            <div class="dorne-signin-btn">
                                <a href="index.php/login/hello">register</a>
                            </div>
                            <div class="dorne-signin-btn">
                                <a href="index.php/log/hello">login</a>
                            </div>
                            <div class="dorne-signin-btn">
                                <a href="index.php/log/hello">hello <?php echo $this->session->userdata('phone_no'); ?></a>
                            </div>
                            <div class="dorne-signin-btn">
            ...
            <div class="row h-100 align-items-center justify-content-center">
                <div class="col-12 col-md-10">
                    <div class="hero-content">
                        ...
                        <h4>This is the best guide of your city <?php echo $this->session->userdata('phone_no'); ?></h4>
                    </div>
                    <!-- Hero Search Form -->
